...
- [创建一个新项目](./projects/creating-a-new-project.md)
- [在现有项目上工作](./projects/working-on-an-existing-project.md)
- [在链上克隆已验证的合约](./projects/clone-a-verified-contract.md)
...
- [测试](./forge/tests.md)
  ...
  - [作弊码](./forge/cheatcodes.md)
  - [Forge 标准库概述](./forge/forge-std.md)
  - [理解追踪](./forge/traces.md)
...
- [参考](./reference/README.md)
  ...
  - [Forge 标准库参考](./reference/forge-std/README.md)
    ...
    - [Std 作弊](./reference/forge-std/std-cheats.md)
    ...
    - [Std 错误](./reference/forge-std/std-errors.md)
    ...
    - [Std 存储](./reference/forge-std/std-storage.md)
